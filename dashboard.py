...
def demand_forecast_section():
    ...
    with st.container():
        ...
        try:
            ...
            # Create a seamless connection by including the last historical point with forecast
            # Get the last historical point
            last_historical_date = monthly_total_sales.index[-1]
            last_historical_value = monthly_total_sales.iloc[-1]
            
            # Create extended forecast data that includes the connection point
            forecast_dates = [last_historical_date] + forecast.index.tolist()
            forecast_values = [last_historical_value] + forecast.values.tolist()
...
# Define sales performance section
def sales_performance():
    ...
    with st.container():
        ...
        # Remove the last TWO data points to stop at second-to-last point (Aug 1)
